...
<head>
    ...
    #centerDiv {
        ...
        overflow-y: auto; /* Thanh cuộn khi nội dung vượt quá chiều cao */
        margin-top: 20px; /* Khoảng cách 20px với upload-form */
    }
</style>
</head>
...
<table style="border-collapse: collapse;"> <!-- Sử dụng inline-block để bảng chỉ chiếm không gian cần thiết -->
		    	<h3 style="color:red ; font-weight: bold; text-align: center ;">Lỗi excel </h3>
		        <thead>

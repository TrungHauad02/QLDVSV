    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <ul class="menu">
                ...
                <li><a href="<%=request.getContextPath()%>/Qtv/listKH" class="special-link">Quản lý khóa học</a></li>
        ...
        <div class="main-content">  
            ...
            <div style="width: 100%;"  class ="tables-container">
                <table border="1" style="width: 69%; border-collapse: collapse; font-size: 20px;">                       

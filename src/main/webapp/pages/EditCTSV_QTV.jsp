    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <ul class="menu">
                ...
                <li><a href="<%=request.getContextPath()%>/Qtv/listCTSV" class="special-link">Quản lý người dùng</a></li>
	            ...
	            <div style="width: 100%; max-height: 40%"  class ="tables-container">
	                <div class="form-row" style="width: 99%">
	                    <div class="column">
							...
							<div class="form-group">
		                        <h3>Quê quán:</h3>
		                        <input type="hidden" id="hiddenquequan" name="hiddenquequan" value="${CTSV.queQuan}">
	                    ...
	                    <div class="column">
							...
							<div class="form-group">
		                        <h3>Địa chỉ:</h3>
		                        <input type="hidden" id="hiddendiachi" name="hiddendiachi" value="${CTSV.diaChi}">

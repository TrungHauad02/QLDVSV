...
<head>
    ...
    <style >
	    ...
	    width: 100%;
	    overflow-x: auto;
	    max-height: 300px; /* Điều chỉnh chiều cao tối đa của khu vực có thanh cuộn */
		}
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-content">  
            ...
            <div class ="tables-container table-wrapper" style="width: 100%"> 
                <table id="studentTable" border="1" style="width: 99%; border-collapse: collapse; font-size: 10px;">                       
                    <thead>
                        <tr>

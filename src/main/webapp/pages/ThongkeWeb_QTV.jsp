    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <ul class="menu">
                ...
                <li><a href="<%=request.getContextPath()%>/pages/ThongkeWeb_QTV.jsp" class="special-link">Thống kê tình hình sử dụng </a></li>
            </ul>
        </div>
        ...
        <div class="main-content">  
            ...
            <div style="width: 100%; max-height: 90%"  class ="tables-container">
        ...
        if (tableBody) {
            ...
            for (var i = 0; i < tableRows.length; i++) {
                ...
                if (cells.length > 0) {
                    ...
                    tongSoLuong++;
                    if (cellValue === "Đã duyệt" || cellValue === "Đã nhận" || cellValue === "Đã tham gia") {
                        daDuyetRowCount++;
                    }
                }
            }

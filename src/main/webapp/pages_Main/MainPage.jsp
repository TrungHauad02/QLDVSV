...
<%@ page import="SameSiteCookie.SamesiteHttpServletResponse"%>
	...
	<body>
		...
		<div class="image-container">
		    <img border="0" src="<%= request.getContextPath()%>/img/SPKT.jpg" alt="Ảnh" class="full-width-img">
		</div>
	    ...
	    <div class="wrapper">
	    	<div class="main-content_Page">
			    <img border="0" src="<%= request.getContextPath()%>/img/Truong_HCMUTE.jpg" alt="Ảnh" class="main-page">
			</div>
	    </div>

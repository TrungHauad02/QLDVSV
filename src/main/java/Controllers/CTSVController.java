...
public class CTSVController extends HttpServlet {
	...
	private void UpdateXNNNRequest(HttpServletRequest request, HttpServletResponse response)
		...
		LocalDateTime thoiGianPhanHoi = LocalDateTime.now();
	...
	private void UpdateHDCTXH(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			boolean isSuccess = hdctxhDAO.UpdateHDCTXH(id, tenHoatDong, diem, noiDung, sqlThoiGianBatDau,
					sqlThoiGianKetThuc);
			request.setAttribute("isSuccess", isSuccess);
	...
	private void sendemail(HttpServletRequest request, HttpServletResponse response, String Tieude, String Noidung,
			String email) throws SQLException, ServletException,

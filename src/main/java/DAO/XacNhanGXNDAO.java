...
public class XacNhanGXNDAO {
	...
	public XacNhanGXN SelectGXNRequestID(String id) {
		...
		try (Connection connection = JDBCUtil.getConnection();
	            ...
	            while (rs.next()) {	
	            	gxn = new XacNhanGXN();
	            	gxn.setID(id);
	            	gxn.setThoiGianDangKi(rs.getTimestamp("ThoiGianDKi").toLocalDateTime());
	...
	public boolean UpdateRequestGXN(String id, LocalDateTime thoiGianPhanHoi, String tieuDe, String MaCTSV, String noiDungPhanHoi) {

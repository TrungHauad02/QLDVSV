...
public class XacNhanNganhNgheDAO {
	...
	public XacNhanNganhNghe SelectXNNNRequestID(String id) {
		...
		try (Connection connection = JDBCUtil.getConnection();
	            ...
	            while (rs.next()) {	
	            	...
	            	xnnn.setThoiGianDangKi(rs.getTimestamp(4).toLocalDateTime());
	...
	public boolean UpdateRequestXNNN(String id, LocalDateTime thoiGianPhanHoi, String tieuDe, String MaCTSV, String noiDungPhanHoi) {        
		try (Connection connection = JDBCUtil.getConnection();

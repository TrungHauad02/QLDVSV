...
public class DangKiCTXHDAO {
	...
	public List<DangKiCTXH> SelectAllRequestsHDCTXH() {
        ...
        try (Connection connection = JDBCUtil.getConnection();      	
            ...
            while (rs.next()) {
            	...
            	LocalDateTime thoigiandangki = rs.getTimestamp("ThoiGianDki").toLocalDateTime();
	...
	public DangKiCTXH SelectDKICTXHRequestID(String id) {
		...
		try (Connection connection = JDBCUtil.getConnection();
	            ...
	            while (rs.next()) {	
	            	...
	            	dkictxh.setID(id);
	            	dkictxh.setThoiGianDangKi(rs.getTimestamp("ThoiGianDKi").toLocalDateTime());
	...
	public boolean UpdateRequestDKICTXH(String id, LocalDateTime thoiGianPhanHoi, String tieuDe, String MaCTSV, String noiDungPhanHoi) {
        // Step 1: Establishing a Connection
        try (Connection connection = JDBCUtil.getConnection();
            // Step 2:Create a statement using connection object
            PreparedStatement preparedStatement = connection.prepareStatement(Update_Request_DKICTXH_ID);) {
            preparedStatement.setTimestamp(1, JDBCUtil.getSQLTimestamp(thoiGianPhanHoi));
